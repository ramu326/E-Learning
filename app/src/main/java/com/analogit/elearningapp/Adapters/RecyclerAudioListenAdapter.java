...
public class RecyclerAudioListenAdapter extends ListAdapter<TopicsModel, RecyclerAudioListenAdapter.MyViewholder> {

    Fragment fragment;

    public RecyclerAudioListenAdapter(Fragment fragment) {
